...
struct perturbs
{
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  short has_source_delta_drad; /**< do we need source for delta of drad  */
  ...
  short has_source_theta_drad; /**< do we need source for theta of drad neutrinos/relics? */
  ...
  int index_tp_delta_drad; /**< index value for delta of decay radiation */
  ...
  int index_tp_theta_drad; /**< index value for theta of dark radiation */
...
struct perturb_vector
{
  ...
  int index_pt_delta_drad; /**< density of ultra-relativistic neutrinos/relics */
  int index_pt_theta_drad; /**< velocity of ultra-relativistic neutrinos/relics */
...
/* perturbed recombination */
  ...
  //int l_max_drad;          /**< max momentum in Boltzmann hierarchy for drad) */
