...
struct background
{
  ...
  double Omega0_drad; /**< \f$ \Omega_{0 drad} \f$ : dark radiation */
  ...
  double Gamma_drad; /**< \f$ \Gamma_{drad} \f$ : coupling constant for dark radiation and cdm */
  ...
  double N_drad;                            /**< Number of distinguishabe drad species */
  ...
  int index_bg_rho_drad;        /**< drad density */
  ...
  int index_bi_rho_drad;  /**< {B} drad density */
  ...
  short has_drad;        /**< presence of relativistic decay radiation? */
